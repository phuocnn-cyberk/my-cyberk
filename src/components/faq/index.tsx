  ...
  return (
    <section className="bg-white py-24">
      <div className="container mx-auto px-4 max-w-4xl">
        <h2 className="text-5xl font-medium text-center mb-10 text-[#181818]">
        ...
        <Accordion type="single" collapsible defaultValue="item-0">
          {FAQ_DATA.map((faq, index) => (
            ...
            >
              <AccordionTrigger className="text-2xl py-10 font-light hover:no-underline text-black">
                <span className="text-[#2684FF] font-semibold text-2xl">
                  {faq.id}
                </span>
                {faq.question}
              </AccordionTrigger>
              <AccordionContent className="text-lg text-[#292929] pt-4">
                {faq.answer}
              </AccordionContent>
            </AccordionItem>
          ))}
