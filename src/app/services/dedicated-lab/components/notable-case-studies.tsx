...
const STORIES_DATA = [
  ...
  {
    logo: "oracler-logo.svg",
    metric: "Revenue Increased",
    value: "1000%",
    description: "faster revenue ramp from earlier launch + user adoption",
    image: "/images/oracler-image.png",
  },
  {
    logo: "helix-logo.svg",
    ...
    <section className="bg-white py-24">
      <div className="container mx-auto px-4">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <h2 className="text-2xl md:text-5xl leading-tight font-normal text-[#212121] mb-4 md:mb-6">
            Notable Case Studies
          </h2>
          <p className="text-sm md:text-xl font-extralight leading-tight text-[#212121]">
